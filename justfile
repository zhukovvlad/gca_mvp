...
# больше, а время выросло в 2,4 раза, и рост непропорционален: профиль
...
# не трогает Postgres. Замер 2026-09-02 (16 ядер): параллельно — 427 с
# (прогон целиком); серийно — около 575 с СУММОЙ отдельно замеренных шагов
