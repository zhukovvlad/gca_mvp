...
# Замер на 16 ядрах (devlog 2026-08-11): серийно 291,6 с, 4 воркёра — 194 с,
# 8 — 173 с, 12 — 151/141 с; дальше кривую держит серийный пол (module-scoped
# разбор оферт и БД-контенция), не число воркёров.
#
