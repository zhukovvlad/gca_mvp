...
паспорта ограничена масштабами операндов из базы. Достижимость проверена
замером, поэтому защиты против неё здесь нет (§11 `AGENTS.md` запрещает
оборонительный код против недостижимого входа).
"""
