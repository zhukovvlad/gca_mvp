...
12. §2 ссылается на существующий файл источников; у файла ровно одна шапка
    ...
    неквалифицированный. Между тем краткая `§N` внутри этого файла по правилу
    §9.2 адресует его самого, а §2 в нём нет — то есть адрес висячий. Первый же
    прогон правила поймал такую строку в самом файле источников.
