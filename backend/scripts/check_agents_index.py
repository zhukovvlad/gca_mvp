...
def reference_files() -> list[Path]:
    ...
    не только для файлов на первом уровне каталога — справочник разросся до
    подкаталога этой же фичей, и форма не вправе стать необязательной на
    втором уровне. `docs/pitfalls/` держит ту же форму `glob`-ом (check_10,
