...
«`AGENTS.md` §2» продолжает означать исходные материалы, меняется лишь то, что
за ним лежит. Ревизии ниже **зафиксированы**: перенос делался с них, и обсуждать их
...
**Лицензии.** На зафиксированной ревизии `udp-tenders` файла LICENSE нет, а все
три исходных репозитория принадлежат автору проекта. Если LICENSE или
copyright notices в источниках появятся — **перенести их файлами**, ссылки в
README недостаточно. Правило пришло из §9.4 `AGENTS.md` (снят ревизией v6.19),
где стояло задачей фазы 1; оно условное и действующее, поэтому живёт здесь, при
самих источниках.
