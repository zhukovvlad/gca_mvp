...
def claims(data: dict) -> list[tuple[str, str, str]]:
    ...
    out = [
        ...
        #: СТОРОЖ САМОГО РАЗБИЕНИЯ: пригодные + непригодные = все. Без
        #: него дыра в комплементе уменьшала бы обе части молча, и каждая
        #: по отдельности выглядела бы правдоподобно (внешнее ревью, круг 5).
