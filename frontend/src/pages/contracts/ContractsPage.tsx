...
export default function ContractsPage() {
  ...
  // переносятся — сравнение берёт всю выборку, а не страницу списка. Значения
  // берутся из состояния ввода, а не из дебаунсенного `search`: адрес обязан
  // отражать то, что человек видит на экране прямо сейчас.
