...
- **[Новое правило надо прогнать, а не описать](docs/insights/replaying-new-rules.md)** — девять случаев в Ф2: свойство проверки утверждалось, не будучи прогнанным по конкретному входу (неисполнимый тест колонки A, ложно-зелёный тест денег, docstring без исполнения), и второй слой — новое правило не прогонялось по **уже существующим** входам (строка лота в общем хелпере, моки в чужом файле, лист без A/B).
