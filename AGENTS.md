...
> граница N с причиной, и в §11 добавлены двое грабель, найденных прогоном стенда:
> печатная раскладка А4 и предел точности чисел в xlsx. Обоснование и замеры —
> `docs/phase6-analytics.md`.
>
